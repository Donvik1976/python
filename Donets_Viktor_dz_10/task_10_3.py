...
# деление (__floordiv__, __truediv__()). Эти методы должны применяться только
# к клеткам и выполнять увеличение, уменьшение, умножение и округление до
...
class Cell():
    ...
    def make_order(self, num):
        return '\n'.join('*' * num for i in range(self.param // num)) + '\n' \
               + '*' * (self.param % num)
    ...
    def __sub__(self, other):
        if self.param - other.param > 0:
            ...
            return 'Получается отрицательное количество клеток или ноль'
